impl<'a> CPU<'a> {
    ...
    fn lda(&mut self, mode: AddressingModes) {
        ...
        self.update_flags(&[
            FlagUpdate::Zero(value_for_acc),
            FlagUpdate::Negative(value_for_acc),
        ]);
    }
    ...
    fn ldx(&mut self, mode: AddressingModes) {
        ...
        self.update_flags(&[
            FlagUpdate::Zero(value_for_x),
            FlagUpdate::Negative(value_for_x),
        ]);
    }
    ...
    fn stx(&mut self, mode: AddressingModes) {
        ...
        self.memory.write(value_for_ram as u16, self.registers.index_x);
    }
    ...
    fn ldy(&mut self, mode: AddressingModes) {
        ...
        self.update_flags(&[
            FlagUpdate::Zero(value_for_y),
            FlagUpdate::Negative(value_for_y),
        ]);
    }

    fn sty(&mut self, mode: AddressingModes) {
        let address = self.get_operand_address(mode);
        self.memory.write(address, self.registers.index_y);
    }
    ...
    fn jsr(&mut self, _mode: AddressingModes) {
        ...
        self.memory.write(0x100 + (self.registers.stack_pointer as usize) as u16, high);
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
        self.memory.write(0x100 + (self.registers.stack_pointer as usize) as u16, low);
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
    ...
    fn rts(&mut self, _mode: AddressingModes) {
        ...
        let low = self.memory.read(0x100 + (self.registers.stack_pointer as usize) as u16);
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        let high = self.memory.read(0x100 + (self.registers.stack_pointer as usize) as u16);
    ...
    fn brk(&mut self, _mode: AddressingModes) {
        ...
        self.memory.write(0x100 + (self.registers.stack_pointer as usize) as u16, status_with_b);
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
        ...
        let low = self.memory.read(0xfffe);
        let high = self.memory.read(0xffff);
    ...
    fn rti(&mut self, _mode: AddressingModes) {
        ...
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        let status = self.memory.read(0x100 + (self.registers.stack_pointer as usize) as u16);
    ...
    fn pha(&mut self, _mode: AddressingModes) {
        self.memory.write(0x100 + (self.registers.stack_pointer as usize) as u16, self.registers.acc);
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
    }

    fn pla(&mut self, _mode: AddressingModes) {
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        self.registers.acc = self.memory.read(0x100 + (self.registers.stack_pointer as usize) as u16);
