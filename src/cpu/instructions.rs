impl Cpu {
    ...
    fn stx(&mut self, mode: AddressingModes) {
        let value_for_memory: u8 = self.execute_mode(mode);
    ...
    fn sty(&mut self, mode: AddressingModes) {
        let address = self.get_operand_address(mode);
        self.memory[address as usize] = self.registers.index_y;
    }
    ...
    fn adc(&mut self, mode: AddressingModes) {
        ...
        // Overflow ocorre quando os sinais dos operandos são iguais, mas diferente do resultado
        let overflow =
    ...
    fn sbc(&mut self, mode: AddressingModes) {
        ...
        // SBC é ADC com o complemento de 1 do operando
    ...
    fn asl(&mut self, mode: AddressingModes) {
        if mode == AddressingModes::Accumulator {
            ...
            self.registers.acc = self.registers.acc << 1;
    ...
    fn jsr(&mut self, _mode: AddressingModes) {
        ...
        self.memory[0x100 + (self.registers.stack_pointer as usize)] = high;
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
        self.memory[0x100 + (self.registers.stack_pointer as usize)] = low;
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
    ...
    fn rts(&mut self, _mode: AddressingModes) {
        ...
        let low = self.memory[0x100 + (self.registers.stack_pointer as usize)];
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        let high = self.memory[0x100 + (self.registers.stack_pointer as usize)];
    ...
    fn brk(&mut self, _mode: AddressingModes) {
        ...
        self.memory[0x100 + (self.registers.stack_pointer as usize)] = status_with_b;
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
        ...
        let low = self.memory[0xfffe];
        let high = self.memory[0xffff];
    ...
    fn rti(&mut self, _mode: AddressingModes) {
        ...
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        let status = self.memory[0x100 + (self.registers.stack_pointer as usize)];
    ...
    fn pha(&mut self, _mode: AddressingModes) {
        self.memory[0x100 + (self.registers.stack_pointer as usize)] = self.registers.acc;
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_sub(1);
    }

    fn pla(&mut self, _mode: AddressingModes) {
        self.registers.stack_pointer = self.registers.stack_pointer.wrapping_add(1);
        self.registers.acc = self.memory[0x100 + (self.registers.stack_pointer as usize)];
